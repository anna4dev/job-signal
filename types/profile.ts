...
// locations.allow: geographic overlap when the job states country/city.
// Remote with no geography passes. Job visa sponsorship bypasses location for
// onsite/hybrid only (relocation). See AGENTS.md / lib/fit.ts locationAllows.
...
export interface Preferences {
  // Non-empty → fit() hard-fails titles that match none (role_constraint).
